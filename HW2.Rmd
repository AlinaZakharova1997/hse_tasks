...
```{r}
# hint: sd()
print(summary(mono_n$RTlog))
print(paste('Std', sd(mono_n$RTlog)))
...
ggarrange(graph_1, graph_2, labels = c("Congruent", "Incongruent"),
...
graph_4 <- mono1 %>%
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))
ggarrange(graph_3, graph_4, labels = c("Congruent", "Incongruent"),
                    ncol = 2, align = 'hv', common.legend = T)
